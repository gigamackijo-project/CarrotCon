-- Active: 1699837540104@@127.0.0.1@3306@board
...
INSERT INTO board(title, content, userId) VALUES('첫번째 게시물', '첫번째 게시물 내용', 3);
INSERT INTO board(title, content, userId) VALUES('두번째 게시물', '두번째 게시물 내용', 4);
INSERT INTO board(title, content, userId) VALUES('세번째 게시물', '세번째 게시물 내용', 5);
...
SELECT * from board;
INSERT INTO board_comment(boardId, userId, content) VALUES(3, 3, '두번째 게시물 댓글 01');
INSERT INTO board_comment(boardId, userId, content) VALUES(3, 4, '두번째 게시물 댓글 02');
INSERT INTO board_comment(boardId, userId, content) VALUES(4, 5, '세번째 게시물 댓글 01');
...
SELECT COUNT(*) count FROM board_comment WHERE boardId = 3;
